...
function s.negcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return e:GetHandler():IsType(TYPE_EFFECT) and not at:IsControler(tp) and not at:IsAttribute (0x04)
end	
function s.target(e,c)
	return not c:IsAttribute(0x04) and c:IsFaceup()
end
...
function s.repfilter(c,tp)
	return c:IsFaceup() and c:IsControler(tp) and c:IsLocation(LOCATION_MZONE) and (c:IsSetCard(0x1f4) or c:IsAttribute(0x04))
